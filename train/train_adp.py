...
from trainer import ADP_Trainer
...
if __name__ == '__main__':
    ...
    save_root = os.path.join('checkpoints', 'adp', 'seed_{:d}'.format(args.seed), '{:d}_{:s}{:d}_{:s}'.format(args.model_num, args.arch, args.depth, args.dataset))
