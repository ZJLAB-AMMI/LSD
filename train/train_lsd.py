...
from trainer import LCM_GAL_Trainer
...
if __name__ == '__main__':
    ...
    save_root = os.path.join('checkpoints', 'lcm_gal_{:.1f}_{:.1f}_{:.1f}'.format(args.ld_coeff, args.alpha, args.beta), 'seed_{:d}'.format(args.seed),
                             '{:d}_{:s}{:d}_{:s}'.format(args.model_num, args.arch, args.depth, args.dataset))
    ...
    # train the ensemble
    trainer = LCM_GAL_Trainer(models, trainloader, testloader, writer, save_root, **vars(args))
    trainer.run()
