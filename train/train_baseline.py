...
from trainer import Baseline_Trainer
...
if __name__ == '__main__':
    ...
    save_root = os.path.join('checkpoints', 'baseline', 'seed_{:d}'.format(args.seed), '{:d}_{:s}{:d}_{:s}'.format(args.model_num, args.arch, args.depth, args.dataset))
    ...
    # train the ensemble
    trainer = Baseline_Trainer(models, optimizers, schedulers, trainloader, testloader, writer, save_root, **vars(args))
    trainer.run()
